    ...
    <div className="max-w-screen-xl mx-auto px-4 sm:px-8 lg:px-16 py-8">
      <section className="flex flex-col items-center gap-10 lg:flex-row lg:justify-between lg:gap-4">
        <div className="w-full lg:w-1/2">
          ...
          <h1 className="block md:hidden banner-title text-center mb-4 whitespace-pre-line">
            Experimente mais <br />
            liberdade no controle da<br />
            vida financeira. Crie <br />
            sua conta com a gente!
          </h1>

          {/* Tablet: de md até lg */}
          <h1 className="hidden md:block lg:hidden banner-title text-center mb-4 whitespace-pre-line">
          ...
          <h1 className="hidden lg:block banner-title text-center mb-4 whitespace-pre-line">
            Experimente mais liberdade no<br />
            controle da sua vida financeira.<br />
            Crie sua conta com a gente!
          </h1>
