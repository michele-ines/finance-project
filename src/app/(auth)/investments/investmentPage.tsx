...
export default function InvestmentPage() {
  ...
  const handleSaveTransactions = (tx: Transaction[]): void => {
    ...
    // …salvar em API / contexto / state global…
  };
  ...
  return (
    ...
    <Box className="flex flex-col gap-6 lg:flex-row">
      ...
      <Box className="flex flex-col gap-6 w-full lg:w-2/3">
        ...
        <Box className={`${styles.cardTransacao} w-full min-h-[478px] gap-14`}>
          {/* …conteúdo de investimentos (caixas + gráfico) … */}
          <section className="flex flex-col gap-6">
            ...
            <div className="flex flex-wrap gap-6">
              ...
              <Box className={`${styles.investmentBox} ${styles.investmentBoxType}`}>
                ...
                <span className={styles.investmentBoxValue}>R$ 12.000,00</span>
              </Box>
            </div>
          </section>
          ...
          <section className="flex flex-col gap-6">
            ...
            <Box className={`${styles.investmentBox} ${styles.investmentBoxStats} min-w-[610px] text-white`}>
              <PieChart series={[{ data: chartData, innerRadius: 40, cornerRadius: 50 }]} {...size} />
            </Box>
          </section>
        </Box>
      </Box>
