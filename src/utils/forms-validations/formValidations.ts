...
//   >,
// };
// src/utils/forms-validations/formValidations.ts
...
// Regras de validação para o formulário de registro
export const registerValidations = {
  name: {
    required: "Nome é obrigatório",
    minLength: { value: 3, message: "Nome deve ter ao menos 3 caracteres" },
...
// Regras de validação para o formulário de Nova Transação
